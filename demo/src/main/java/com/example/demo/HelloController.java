...
//        alltiles.get(99).setNextTile(null);
        ...
        int count = 1000;
        while(count-->0){
            SequentialTransition arrowTransition = new SequentialTransition(arrow);
            TranslateTransition trans = new TranslateTransition();
            trans.setDuration(Duration.millis(20));
            trans.setByY(100);
            arrowTransition.getChildren().add(trans);
            TranslateTransition trans1 = new TranslateTransition();
            trans1.setDuration(Duration.millis(20));
            trans1.setByY(-100);
            arrowTransition.getChildren().add(trans1);
